	...
	<body>
		...
		<form action="<?= base_url(''); ?>formsiswa/cetak" method="post">
				<table class="table table-bordered border-warning mt-3" align="center">
					<thead>
						<tr>
							<th colspan="3"><h2 class="text-center">BIODATA</h2></th>
						</tr>
					</thead>
					<tbody>
						<tr>
		...
		<div class="container text-center">
		<a href="<?= base_url('viewsiswa'); 
                ?>"></a>
			<button type="submit" class="btn btn-outline-warning" value="sumbit">
				Submit
			</button>
		</div>
